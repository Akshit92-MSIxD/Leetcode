...
class Solution {
    ...
    TreeNode dfs(TreeNode curr, TreeNode parent,int start, HashMap<TreeNode,TreeNode> parentMp)
    {
       if(curr == null)
       return null;
      ...
      TreeNode left =  dfs(curr.left,curr,start,parentMp);
       TreeNode right = dfs(curr.right,curr,start,parentMp);
    ...
    public int amountOfTime(TreeNode root, int start) {
          ...
          TreeNode startNode = dfs(root,null,start,parentMp);
