// DSU + Array approach left !!!
// Please read both Approach 1 and Approach 2(DSU + HashMap) below !!!
...
// Approach 2 : Using DSU + HashMap(Written By Me :) (!!! Space optimized algo)
// TC : O(n*m)
// SC : O(n*m) (Only in worst case when there is no(water) in the matrix)
