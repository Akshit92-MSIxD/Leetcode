 ...
 */
 ...
 // Note : I have written three approaches for this problem . All three approaches are similar but important !!!
...
// Approach 2 : Using Pure Recursive DFS(Expectation + Faith concept) + HashMap !!! (Strivers Solution)
// Watch : https://www.youtube.com/watch?v=aZNaLrVebKQ&list=PLkjdNRgDmcc0Pom5erUBU4ZayeU9AyRRu&index=34
...
/*------------------------------------------------------------------------------------------------------------*/
 ...
 // Approach 3 : DFS (Similar to Approach 1 and 2 but reduced function paremeters !!!) (CodewithMiks Solution)
...
//     TreeNode createBTree(int inStart, int inEnd, int[] inorder, int[] preorder)
//     {
//         if(inStart > inEnd)
//         return null;
...
//         root.left = createBTree(inStart,rootPos-1,inorder,preorder);
//         root.right = createBTree(rootPos+1,inEnd,inorder,preorder);
